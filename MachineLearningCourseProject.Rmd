...
trainingset <- read.csv(file="c:/Coursera/Practical Machine Learning/pml-training.csv", sep=",", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv(file="c:/Coursera/Practical Machine Learning/pml-testing.csv", sep=",", na.strings=c("NA","#DIV/0!", ""))
...
####A graphical look at our test data
